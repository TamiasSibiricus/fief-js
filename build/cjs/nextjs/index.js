...
const defaultAPIUnauthorizedResponse = (req, res) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    res.status(401).send('Unauthorized');
});
const defaultAPIForbiddenResponse = (req, res) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
...
class FiefAuth {
    constructor(parameters) {
        ...
        this.fiefAuth = new server.FiefAuth(parameters.client, server.cookieGetter(parameters.sessionCookieName), parameters.userInfoCache);
        this.fiefAuthEdge = new server.FiefAuth(parameters.client, (request) => tslib_es6.__awaiter(this, void 0, void 0, function* () { var _a; return ((_a = request.cookies.get(parameters.sessionCookieName)) === null || _a === void 0 ? void 0 : _a.value) || null; }));
    ...
    middleware(pathsConfig) {
        ...
        return (request) => tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            if (request.nextUrl.pathname === this.redirectPath) {
                ...
                const response = server$1.NextResponse.redirect(redirectURL);
            ...
            if (request.nextUrl.pathname === this.logoutPath) {
                ...
                const response = server$1.NextResponse.redirect(logoutURL);
            ...
            if (matchingPath) {
                try {
                    ...
                    return server$1.NextResponse.next({ request: { headers: requestHeaders } });
                }
                catch (err) {
                    if (err instanceof server.FiefAuthUnauthorized) {
                        const authURL = yield this.client.getAuthURL({ redirectURI: this.redirectURI, scope: ['openid'] });
                        const response = server$1.NextResponse.redirect(authURL);
                        response.cookies.set(this.returnToCookieName, `${request.nextUrl.pathname}${request.nextUrl.search}`);
                        return response;
                    }
                    if (err instanceof server.FiefAuthForbidden) {
                        return server$1.NextResponse.rewrite(new URL(this.forbiddenPath, request.url));
                    }
                    throw err;
                }
            }
    ...
    authenticated(route, authenticatedParameters = {}) {
        ...
        return (req, res) => tslib_es6.__awaiter(this, void 0, void 0, function* () {
            let user = null;
    ...
    currentUser() {
        return (req, res) => tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.authenticated((_req, _res) => tslib_es6.__awaiter(this, void 0, void 0, function* () {
     ...
     */
    getUserInfo(req_1) {
        return tslib_es6.__awaiter(this, arguments, void 0, function* (req, refresh = false) {
