 ...
 */
const defaultUnauthorizedResponse = (req, res) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
 ...
 * @param res  - An Express `Response` object.
 */
const defaultForbiddenResponse = (req, res) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
...
const createMiddleware = (parameters) => {
    const fiefAuthServer = new server.FiefAuth(parameters.client, parameters.tokenGetter, parameters.userInfoCache);
...
exports.authorizationSchemeGetter = server.authorizationSchemeGetter;
exports.cookieGetter = server.cookieGetter;
