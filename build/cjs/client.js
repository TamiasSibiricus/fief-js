...
var index$1 = require('./crypto/index.js');
...
(function (FiefACR) {
     ...
     */
    FiefACR["LEVEL_ONE"] = "1";
})(exports.FiefACR || (exports.FiefACR = {}));
const ACR_LEVELS_ORDER = [exports.FiefACR.LEVEL_ZERO, exports.FiefACR.LEVEL_ONE];
...
class Fief {
    constructor(parameters) {
        ...
        this.fetch = index.getFetch();
        this.requestInit = parameters.requestInit;
        this.crypto = index$1.getCrypto();
    }
    /**
    ...
    validateAccessToken(accessToken, requiredScopes, requiredACR, requiredPermissions) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            const signatureKeys = jose__namespace.createLocalJWKSet(yield this.getJWKS());
            try {
                const { payload: claims } = yield jose__namespace.jwtVerify(accessToken, signatureKeys);
                ...
                if (acr === undefined || !Object.values(exports.FiefACR).includes(acr)) {
                    throw new FiefAccessTokenInvalid();
                }
                if (requiredACR) {
                ...
                if (err instanceof jose__namespace.errors.JWTExpired) {
                    throw new FiefAccessTokenExpired();
                }
                else if (err instanceof jose__namespace.errors.JOSEError) {
                    throw new FiefAccessTokenInvalid();
                }
                throw err;
            }
    ...
    decodeIDToken(parameters) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            const signatureKeys = jose__namespace.createLocalJWKSet(jwks);
            try {
                let signedToken = idToken;
                if (this.encryptionKey !== undefined) {
                    const { plaintext } = yield jose__namespace.compactDecrypt(idToken, this.encryptionKey);
                    signedToken = plaintext;
                }
                const { payload: claims } = yield jose__namespace.jwtVerify(signedToken, signatureKeys);
                ...
                if (err instanceof jose__namespace.errors.JOSEError) {
                    throw new FiefIdTokenInvalid();
                }
                throw err;
            }
...
exports.Fief = Fief;
exports.FiefAccessTokenACRTooLow = FiefAccessTokenACRTooLow;
exports.FiefAccessTokenExpired = FiefAccessTokenExpired;
exports.FiefAccessTokenInvalid = FiefAccessTokenInvalid;
exports.FiefAccessTokenMissingPermission = FiefAccessTokenMissingPermission;
exports.FiefAccessTokenMissingScope = FiefAccessTokenMissingScope;
exports.FiefError = FiefError;
exports.FiefIdTokenInvalid = FiefIdTokenInvalid;
exports.FiefRequestError = FiefRequestError;
